...
rsfmri = read.abcd("ABCDStudyNDA_1182451/mrirscor02.txt") %>% 
  select(subjectkey,eventname,
         Lamyg_CingOperc = rsfmri_cor_ngd_cerc_scs_aglh,
         Ramyg_CingOperc = rsfmri_cor_ngd_cerc_scs_agrh,
...
```{r}
# write file
write.csv(abcd, "./data/ABCD_cooked_2022_04_15.csv", row.names = FALSE)
```
